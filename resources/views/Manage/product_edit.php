						...
						<div class="panel-body">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="title" name="title" placeholder="产品标题" value="<?=$data['title']?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" class="form-control" id="brandname" placeholder="关联品牌" value="<?=$data['brandname']?>" readonly>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" id="image" placeholder="680&nbsp;*&nbsp;340像素" value="<?=$data['image']?>">
											<span class="input-group-btn">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="viewnum" name="viewnum" placeholder="访问次数" value="<?=$data['viewnum']?>">
									</div>
								</div>
								<div class="form-group">
									<label for="tag" class="col-sm-2 control-label">*&nbsp;标签</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="tag" name="tag" placeholder="标签" value="<?=$data['tag']?>">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-12 text-center">
										<div class="btn-group" role="group">
											...
											<a class="btn btn-default" href="#">预览</a>
