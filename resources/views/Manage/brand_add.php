				...
				<div class="col-sm-10 col-sm-push-2" id="mainWindow">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 添加品牌
						</div>
						<div class="panel-body">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="brand" name="brand" placeholder="品牌中文名">
									</div>
								</div>
								<div class="form-group">
									<label for="branden" class="col-sm-2 control-label">*&nbsp;品牌英文名</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="branden" name="branden" placeholder="品牌英文名">
									</div>
								</div>
								<div class="form-group">
									<label for="website" class="col-sm-2 control-label">官网地址</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="website" name="website" placeholder="官网地址">
									</div>
								</div>
								<div class="form-group">
									<label for="founder" class="col-sm-2 control-label">创始人</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="founder" name="founder" placeholder="创始人">
									</div>
								</div>
								<div class="form-group">
									<label for="foundtime" class="col-sm-2 control-label">创始时间</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="foundtime" name="foundtime" placeholder="创始时间">
									</div>
								</div>
								<div class="form-group">
									<label for="cradle" class="col-sm-2 control-label">发源地</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="cradle" name="cradle" placeholder="发源地">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" id="logo" placeholder="品牌LOGO">
											<span class="input-group-btn">
